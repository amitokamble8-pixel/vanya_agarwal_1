...
export function Home() {
  ...
  return (
    <>
      ...
      <section className="section">
        <SectionHead icon="book" title="Articles & Publications" to="/publications" />
        <div className="stack">
          {ARTICLES.map((a, i) => (
      ...
      <section className="section">
        <SectionHead icon="people" title="Leadership & Service" to="/volunteering" />
        <Reveal>
...
export function Work() {
  usePageMeta(`Work | ${SITE}`, "Work experience, roles, and responsibilities.");
  return (
    <section className="section">
      <PageHead icon="briefcase" title="Work Experience" lead="" />
      <div className="stack">
        {EXPERIENCE.map((e, i) => (
...
export function Projects() {
  ...
  return (
    <section className="section">
      <PageHead icon="code" title="Featured Projects" lead="" />
      <div className="stack">
        {PROJECTS.map((p, i) => (
...
export function Publications() {
  usePageMeta(`Articles & Publications | ${SITE}`, "Areas of mathematical and computational interest.");
  return (
    <section className="section">
      <PageHead icon="book" title="Articles & Publications" lead="" />
      <div className="stack">
        {ARTICLES.map((a, i) => (
          <Reveal key={a.title} delay={i * 60}><ArticleRow a={a} /></Reveal>
        ))}
...
export function Volunteering() {
  usePageMeta(`Leadership & Service | ${SITE}`, "Leadership roles and service contributions.");
  return (
    <section className="section">
      <PageHead icon="people" title="Leadership & Service" lead="" />
      <Reveal>
        <div className="vol-panel">
          <div className="vol-stats">
            {VOLUNTEER.stats.map((s) => (
...
export function Sports() {
  usePageMeta(`Voice & Diplomacy | ${SITE}`, "Debate, Model United Nations, and diplomatic engagement.");
  return (
    <section className="section">
      <PageHead
        icon="trophy"
        title="Voice & Diplomacy"
        lead=""
      />
      <div className="grid-3 tight">
        {SPORTS.map((s, i) => (
